...
<nav>
	<ul>
		...
		<li><a href="?page=AddCourse2" class="<?php if(isset($_GET['page']) && $_GET['page'] === 'AddCourse2') echo 'active'; ?>">Add Course</a></li>
    ...
    <main>
		<?php if (isset($_GET['page'])) {
			...
			elseif ($_GET['page'] === 'AddCourse2')
				include('chair/AddCourse2.php');
